define( ['require', 'jquery', './Grid/Options', './PlaceNotation', './Canvas', './MeasureCanvasTextOffset'], function( require, $, GridOptions, PlaceNotation, Canvas, MeasureCanvasTextOffset ) {
